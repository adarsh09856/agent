...
const getCallProgress = (status: string, metadata?: any) => {
  ...
  const statusMap: Record<string, { label: string; progress: number; description: string; isComplete: boolean; isError: boolean }> = {
    // Standard Twilio / ElevenLabs statuses
    ...
    // SIP / ElevenLabs SIP statuses
    "done": { label: "Call Completed", progress: 100, description: "Test call finished successfully", isComplete: true, isError: false },
    "ended": { label: "Call Ended", progress: 100, description: isUserHangup ? "Call ended by user" : "Call has ended", isComplete: true, isError: false },
    // Custom Voice Engine (ve_sessions) statuses
    "active": { label: "Call In Progress", progress: 70, description: "Call connected - testing flow...", isComplete: false, isError: false },
    "initializing": { label: "Initiating Call", progress: 15, description: "Setting up the call...", isComplete: false, isError: false },
    "connecting": { label: "Connecting", progress: 30, description: "Establishing connection...", isComplete: false, isError: false },
  };
  return statusMap[status] || { label: "Call In Progress", progress: 50, description: "Processing call...", isComplete: false, isError: false };
};
