...
const timeRanges = [
  { value: "7d", label: "7 Days", key: "7d" },
  { value: "30d", label: "30 Days", key: "30d" },
  { value: "90d", label: "90 Days", key: "90d" },
  { value: "all", label: "All Time", key: "all" },
];
...
export default function Analytics() {
  ...
  const planDistribution = [
    { name: t("adminDashboard.analytics.distribution.pro"), value: analytics?.proPlanUsers || 0, fill: CHART_COLORS.pro },
    { name: t("adminDashboard.analytics.distribution.free"), value: analytics?.freePlanUsers || 0, fill: CHART_COLORS.free },
  ];
      ...
      <div className="flex items-center justify-end gap-2 flex-wrap">
        <div className="flex items-center bg-muted rounded-lg p-1">
          {timeRanges.map((range) => (
            ...
            >
              {t(`adminDashboard.analytics.timeRanges.${range.key}`)}
            </Button>
          ))}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.totalUsers")}</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-1">
              {isAllTime ? (
                <span className="text-xs text-muted-foreground">{t("adminDashboard.analytics.metrics.totalUsersDesc")}</span>
              ) : (
                <>
                  ...
                  <span className="text-xs text-muted-foreground">{t("adminDashboard.analytics.metrics.vsLastPeriod")}</span>
                </>
              )}
            </div>
          </CardContent>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.totalCalls")}</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-1">
              {isAllTime ? (
                <span className="text-xs text-muted-foreground">{analytics?.successRate?.toFixed(1) || 0}% {t("adminDashboard.analytics.metrics.successRate")}</span>
              ) : (
                <>
                  ...
                  <span className="text-xs text-muted-foreground">{analytics?.successRate?.toFixed(1) || 0}% {t("adminDashboard.analytics.metrics.success")}</span>
                </>
              )}
            </div>
          </CardContent>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-amber-50 to-white dark:from-amber-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.activeCampaigns")}</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-1">
              {isAllTime ? (
                <span className="text-xs text-muted-foreground">{t("adminDashboard.analytics.metrics.totalCampaignsDesc")}</span>
              ) : (
                <>
                  ...
                  <span className="text-xs text-muted-foreground">{t("adminDashboard.analytics.metrics.acrossPlatform")}</span>
                </>
              )}
            </div>
          </CardContent>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-violet-50 to-white dark:from-violet-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.qualifiedLeads")}</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-1">
              ...
              <span className="text-xs text-muted-foreground">{t("adminDashboard.analytics.metrics.conversionRate")}</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-cyan-50 to-white dark:from-cyan-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.phoneNumbers")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">{t("adminDashboard.analytics.metrics.activeAcrossPlatform")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-rose-50 to-white dark:from-rose-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.totalContacts")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">{t("adminDashboard.analytics.metrics.contactsInSystem")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-brand/5 to-background dark:from-brand/10 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.knowledgeBases")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">{t("adminDashboard.analytics.metrics.ragDocuments")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-fuchsia-50 to-white dark:from-fuchsia-950/30 dark:to-background">
          ...
          <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-foreground/80">{t("adminDashboard.analytics.metrics.proUsers")}</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">{t("adminDashboard.analytics.metrics.freeUsers", { count: analytics?.freePlanUsers || 0 })}</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                {t("adminDashboard.analytics.growth.title")}
              </CardTitle>
              <CardDescription>
                {t("adminDashboard.analytics.growth.description")}
              </CardDescription>
            </div>
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-indigo-500" />
                <span className="text-muted-foreground">{t("adminDashboard.analytics.growth.users")}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-emerald-500" />
                <span className="text-muted-foreground">{t("adminDashboard.analytics.growth.calls")}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-amber-500" />
                <span className="text-muted-foreground">{t("adminDashboard.analytics.growth.campaigns")}</span>
              </div>
            </div>
          </div>
        </CardHeader>
          ...
          <ResponsiveContainer width="100%" height={350}>
            <AreaChart data={growthData}>
              ...
              <Area
                ...
                strokeWidth={2}
                fill="url(#colorUsers)"
                name={t("adminDashboard.analytics.growth.users")}
              />
              <Area
                type="monotone"
                dataKey="calls"
                ...
                strokeWidth={2}
                fill="url(#colorCalls)"
                name={t("adminDashboard.analytics.growth.calls")}
              />
              <Area
                type="monotone"
                dataKey="campaigns"
                ...
                name={t("adminDashboard.analytics.growth.campaigns")}
              />
            </AreaChart>
          </ResponsiveContainer>
        </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("adminDashboard.analytics.distribution.title")}
            </CardTitle>
            <CardDescription>
              {t("adminDashboard.analytics.distribution.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="flex items-center justify-center gap-6 mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">{t("adminDashboard.analytics.distribution.pro")}: {analytics?.proPlanUsers || 0}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full" style={{ backgroundColor: CHART_COLORS.free }} />
                <span className="text-sm">{t("adminDashboard.analytics.distribution.free")}: {analytics?.freePlanUsers || 0}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("adminDashboard.analytics.performance.title")}
            </CardTitle>
            <CardDescription>
              {t("adminDashboard.analytics.performance.description")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={280}>
              <BarChart
                data={[
                  {
                    metric: t("adminDashboard.analytics.performance.successRate"),
                    value: analytics?.successRate || 0,
                    fill: CHART_COLORS.success
                  },
                  {
                    metric: t("adminDashboard.analytics.performance.qualifiedRate"),
              ...
              >
                ...
                >
                  {[
                    { metric: t("adminDashboard.analytics.performance.successRate"), fill: CHART_COLORS.success },
                    { metric: t("adminDashboard.analytics.performance.qualifiedRate"), fill: CHART_COLORS.qualified }
                  ].map((entry, index) => (
                    <Cell key={`cell-${index}`} fill={entry.fill} />
                  ))}
                </Bar>
            ...
            <div className="flex items-center justify-center gap-6 mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">{t("adminDashboard.analytics.performance.success")}: {(analytics?.successRate || 0).toFixed(1)}%</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full" style={{ backgroundColor: CHART_COLORS.qualified }} />
                <span className="text-sm">{t("adminDashboard.analytics.performance.qualified")}: {conversionRate.toFixed(1)}%</span>
              </div>
            </div>
          </CardContent>
        </Card>
