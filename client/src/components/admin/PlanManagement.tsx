...
interface Plan {
  ...
  yookassaMonthlyPrice?: number | null;
  yookassaYearlyPrice?: number | null;
  maxAgents: number;
  maxCampaigns: number;
  ...
  yookassaMonthlyPlanId?: string | null;
  yookassaYearlyPlanId?: string | null;
}
        ...
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-green-50 text-green-700 border-green-200 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800">
              ...
              {t("adminDashboard.plans.status.synced", { gateway: "Razorpay" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.integration", { gateway: "Razorpay" })}</p>
            <p className="text-muted-foreground truncate">{t("adminDashboard.plans.razorpay.monthlyPlan")}: {plan.razorpayPlanId}</p>
            {plan.razorpayYearlyPlanId && (
              <p className="text-muted-foreground truncate">{t("adminDashboard.plans.razorpay.yearlyPlan")}: {plan.razorpayYearlyPlanId}</p>
            )}
          </div>
        </TooltipContent>
      </Tooltip>
        ...
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-950/30 dark:text-yellow-400 dark:border-yellow-800">
              ...
              {t("adminDashboard.plans.status.partial", { gateway: "Razorpay" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.missingPlanIds", { gateway: "Razorpay" })}</p>
            {hasMonthlyPrice && !hasMonthlyPlan && <p className="text-destructive">{t("adminDashboard.plans.razorpay.noMonthlyId")}</p>}
            {hasYearlyPrice && !hasYearlyPlan && <p className="text-destructive">{t("adminDashboard.plans.razorpay.noYearlyId")}</p>}
            <p className="text-muted-foreground mt-1">{t("adminDashboard.plans.tooltips.saveToSync", { gateway: "Razorpay" })}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    );
        ...
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950/30 dark:text-blue-400 dark:border-blue-800">
              <CheckCircle2 className="h-3 w-3" />
              {t("adminDashboard.plans.plans.free")}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.freePlanNote", { gateway: "Razorpay" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
        ...
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help text-muted-foreground">
              ...
              {t("adminDashboard.plans.noInrPricing")}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.setInrPrices")}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
      ...
      <TooltipTrigger asChild>
        <span>
          <Badge variant="outline" className="gap-1 cursor-help bg-orange-50 text-orange-700 border-orange-200 dark:bg-orange-950/30 dark:text-orange-400 dark:border-orange-800">
            <RefreshCw className="h-3 w-3" />
            {t("adminDashboard.plans.status.needsSync")}
          </Badge>
        </span>
      </TooltipTrigger>
      <TooltipContent side="bottom">
        <p className="text-xs">{t("adminDashboard.plans.tooltips.saveToSync", { gateway: "Razorpay" })}</p>
      </TooltipContent>
    </Tooltip>
  );
}
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-green-50 text-green-700 border-green-200 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800">
              <CheckCircle2 className="h-3 w-3" />
              {t("adminDashboard.plans.status.synced", { gateway: "Stripe" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.integration", { gateway: "Stripe" })}</p>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-950/30 dark:text-yellow-400 dark:border-yellow-800">
              <RefreshCw className="h-3 w-3" />
              {t("adminDashboard.plans.status.partial", { gateway: "Stripe" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.missingPlanIds", { gateway: "Stripe" })}</p>
            ...
            <p className="text-muted-foreground mt-1">{t("adminDashboard.plans.tooltips.saveToSync", { gateway: "Stripe" })}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    );
      ...
      <TooltipTrigger asChild>
        <span>
          <Badge variant="outline" className="gap-1 cursor-help bg-red-50 text-red-700 border-red-200 dark:bg-red-950/30 dark:text-red-400 dark:border-red-800">
            <XCircle className="h-3 w-3" />
            {t("adminDashboard.plans.status.notSynced", { gateway: "Stripe" })}
          </Badge>
        </span>
      </TooltipTrigger>
      <TooltipContent side="bottom">
        <p className="text-xs">{t("adminDashboard.plans.status.notConfigured", { gateway: "Stripe" })}</p>
      </TooltipContent>
    </Tooltip>
  );
}
...
function PayPalSyncStatus({ plan, paypalCurrency }: { plan: Plan; paypalCurrency: string }) {
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-green-50 text-green-700 border-green-200 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800">
              <CheckCircle2 className="h-3 w-3" />
              {t("adminDashboard.plans.status.synced", { gateway: "PayPal" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.integration", { gateway: `PayPal (${paypalCurrency})` })}</p>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-950/30 dark:text-yellow-400 dark:border-yellow-800">
              <RefreshCw className="h-3 w-3" />
              {t("adminDashboard.plans.status.partial", { gateway: "PayPal" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.missingPlanIds", { gateway: "PayPal" })}</p>
            ...
            <p className="text-muted-foreground mt-1">{t("adminDashboard.plans.tooltips.clickToSync", { gateway: "PayPal" })}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    );
  ...
  if (isFreePlan) {
    return (
      <Tooltip>
        ...
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.freePlanNote", { gateway: "PayPal" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help text-muted-foreground">
              <XCircle className="h-3 w-3" />
              {t("adminDashboard.plans.tooltips.noPricing", { currency: paypalCurrency })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: paypalCurrency, gateway: "PayPal" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="bottom">
        <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: paypalCurrency, gateway: "PayPal" })} {t("adminDashboard.plans.tooltips.clickToSync", { gateway: "PayPal" })}</p>
      </TooltipContent>
    </Tooltip>
  );
}
...
function PaystackSyncStatus({ plan, paystackCurrency }: { plan: Plan; paystackCurrency: string }) {
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-green-50 text-green-700 border-green-200 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800">
              <CheckCircle2 className="h-3 w-3" />
              {t("adminDashboard.plans.status.synced", { gateway: "Paystack" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.integration", { gateway: `Paystack (${paystackCurrency})` })}</p>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-950/30 dark:text-yellow-400 dark:border-yellow-800">
              <RefreshCw className="h-3 w-3" />
              {t("adminDashboard.plans.status.partial", { gateway: "Paystack" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.missingPlanIds", { gateway: "Paystack" })}</p>
            ...
            <p className="text-muted-foreground mt-1">{t("adminDashboard.plans.tooltips.clickToSync", { gateway: "Paystack" })}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    );
  ...
  if (isFreePlan) {
    return (
      <Tooltip>
        ...
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.freePlanNote", { gateway: "Paystack" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help text-muted-foreground">
              <XCircle className="h-3 w-3" />
              {t("adminDashboard.plans.tooltips.noPricing", { currency: paystackCurrency })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: paystackCurrency, gateway: "Paystack" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="bottom">
        <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: paystackCurrency, gateway: "Paystack" })} {t("adminDashboard.plans.tooltips.clickToSync", { gateway: "Paystack" })}</p>
      </TooltipContent>
    </Tooltip>
  );
}
...
function MercadoPagoSyncStatus({ plan, mercadopagoCurrency }: { plan: Plan; mercadopagoCurrency: string }) {
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-green-50 text-green-700 border-green-200 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800">
              <CheckCircle2 className="h-3 w-3" />
              {t("adminDashboard.plans.status.synced", { gateway: "MercadoPago" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.integration", { gateway: `MercadoPago (${mercadopagoCurrency})` })}</p>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-950/30 dark:text-yellow-400 dark:border-yellow-800">
              <RefreshCw className="h-3 w-3" />
              {t("adminDashboard.plans.status.partial", { gateway: "MercadoPago" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.missingPlanIds", { gateway: "MercadoPago" })}</p>
            {hasMonthlyPrice && !hasMonthlyPlan && <p className="text-destructive">No Monthly Plan ID</p>}
            {hasYearlyPrice && !hasYearlyPlan && <p className="text-destructive">No Yearly Plan ID</p>}
            <p className="text-muted-foreground mt-1">{t("adminDashboard.plans.tooltips.clickToSync", { gateway: "MercadoPago" })}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    );
  ...
  if (isFreePlan) {
    return (
      <Tooltip>
        ...
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.freePlanNote", { gateway: "MercadoPago" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help text-muted-foreground">
              <XCircle className="h-3 w-3" />
              {t("adminDashboard.plans.tooltips.noPricing", { currency: mercadopagoCurrency })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: mercadopagoCurrency, gateway: "MercadoPago" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="bottom">
        <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: mercadopagoCurrency, gateway: "MercadoPago" })} {t("adminDashboard.plans.tooltips.clickToSync", { gateway: "MercadoPago" })}</p>
      </TooltipContent>
    </Tooltip>
  );
}

function YookassaSyncStatus({ plan, yookassaCurrency }: { plan: Plan; yookassaCurrency: string }) {
  const { t } = useTranslation();
  const isFreePlan = plan.monthlyPrice === 0 && plan.yearlyPrice === 0;
  
  const hasMonthlyPrice = (plan.yookassaMonthlyPrice ?? 0) > 0;
  const hasYearlyPrice = (plan.yookassaYearlyPrice ?? 0) > 0;
  const hasAnyPricing = hasMonthlyPrice || hasYearlyPrice;
  
  const hasMonthlyPlan = !!plan.yookassaMonthlyPlanId;
  const hasYearlyPlan = !!plan.yookassaYearlyPlanId;
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-green-50 text-green-700 border-green-200 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800">
              <CheckCircle2 className="h-3 w-3" />
              {t("adminDashboard.plans.status.synced", { gateway: "YooKassa" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.integration", { gateway: `YooKassa (${yookassaCurrency})` })}</p>
            <p className="text-muted-foreground truncate">Monthly: {plan.yookassaMonthlyPlanId}</p>
            {plan.yookassaYearlyPlanId && (
              <p className="text-muted-foreground truncate">Yearly: {plan.yookassaYearlyPlanId}</p>
            )}
          </div>
        </TooltipContent>
      </Tooltip>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help bg-yellow-50 text-yellow-700 border-yellow-200 dark:bg-yellow-950/30 dark:text-yellow-400 dark:border-yellow-800">
              <RefreshCw className="h-3 w-3" />
              {t("adminDashboard.plans.status.partial", { gateway: "YooKassa" })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            <p className="font-medium">{t("adminDashboard.plans.tooltips.missingPlanIds", { gateway: "YooKassa" })}</p>
            {hasMonthlyPrice && !hasMonthlyPlan && <p className="text-destructive">No Monthly Plan ID</p>}
            {hasYearlyPrice && !hasYearlyPlan && <p className="text-destructive">No Yearly Plan ID</p>}
            <p className="text-muted-foreground mt-1">{t("adminDashboard.plans.tooltips.clickToSync", { gateway: "YooKassa" })}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    );
  ...
  if (isFreePlan) {
    return (
      <Tooltip>
        ...
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.freePlanNote", { gateway: "YooKassa" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span>
            <Badge variant="outline" className="gap-1 cursor-help text-muted-foreground">
              <XCircle className="h-3 w-3" />
              {t("adminDashboard.plans.tooltips.noPricing", { currency: yookassaCurrency })}
            </Badge>
          </span>
        </TooltipTrigger>
        <TooltipContent side="bottom">
          <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: yookassaCurrency, gateway: "YooKassa" })}</p>
        </TooltipContent>
      </Tooltip>
    );
  }
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent side="bottom">
        <p className="text-xs">{t("adminDashboard.plans.tooltips.setPricing", { currency: yookassaCurrency, gateway: "YooKassa" })} {t("adminDashboard.plans.tooltips.clickToSync", { gateway: "YooKassa" })}</p>
      </TooltipContent>
    </Tooltip>
  );
}
...
export default function PlanManagement() {
  ...
  const [newPlanForm, setNewPlanForm] = useState<Partial<Plan>>({
    ...
    yookassaMonthlyPrice: 0,
    yookassaYearlyPrice: 0,
    maxAgents: 1,
    maxCampaigns: 1,
  ...
  const yookassaCurrency = paymentGateway?.yookassaCurrency?.toUpperCase() || "RUB";
  ...
  const yookassaCurrencySymbol = getCurrencySymbol(yookassaCurrency);
  ...
  const createPlan = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: t("adminDashboard.plans.planCreated") });
    ...
    onError: (error: any) => {
      toast({
        title: t("adminDashboard.plans.createFailed"),
  ...
  const updatePlan = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/admin/plans"] });
      toast({ title: t("adminDashboard.plans.planUpdated") });
      setEditingPlan(null);
    },
    onError: (error: any) => {
      toast({
        title: t("adminDashboard.plans.updateFailed"),
        description: error.message,
        variant: "destructive"
      });
    }
  ...
  const deletePlan = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/admin/plans"] });
      toast({ title: t("adminDashboard.plans.planDeleted") });
    ...
    onError: async (error: any) => {
      ...
      toast({
        title: error?.error || t("adminDashboard.plans.deleteFailed"),
  ...
  const migrateUsers = useMutation({
    ...
    onSuccess: (data) => {
      toast({ 
        title: t("adminDashboard.plans.usersMigrated"),
        description: t("adminDashboard.plans.usersMigratedDesc", { 
    ...
    onError: (error: any) => {
      toast({
        title: t("adminDashboard.plans.migrationFailed"),
        description: error.message,
        variant: "destructive"
      });
    }
  ...
  const syncToYookassa = useMutation({
    mutationFn: async (planId: string) => {
      const response = await apiRequest("POST", `/api/admin/plans/${planId}/sync/yookassa`);
      if (!response.ok) {
        const errorData = await response.json();
        throw new Error(errorData.error || 'YooKassa sync failed');
      }
      return response.json();
    },
    onSuccess: (data) => {
      queryClient.invalidateQueries({ queryKey: ["/api/admin/plans"] });
      toast({ 
        title: "YooKassa Sync Complete",
        description: data.message
      });
    },
    onError: (error: any) => {
      toast({
        title: "YooKassa Sync Failed",
        description: error.message,
        variant: "destructive"
      });
    }
  ...
  const handleSave = (planId: string) => {
    ...
    // YooKassa
    if (normalizedUpdates.yookassaMonthlyPrice !== undefined) {
      const val = normalizedUpdates.yookassaMonthlyPrice;
      if (val === null || (typeof val === 'number' && (isNaN(val) || val === 0))) {
        normalizedUpdates.yookassaMonthlyPrice = null;
      }
    }
    if (normalizedUpdates.yookassaYearlyPrice !== undefined) {
      const val = normalizedUpdates.yookassaYearlyPrice;
      if (val === null || (typeof val === 'number' && (isNaN(val) || val === 0))) {
        normalizedUpdates.yookassaYearlyPrice = null;
      }
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl md:text-2xl font-bold">{t("adminDashboard.plans.title")}</h2>
          <p className="text-muted-foreground text-sm md:text-base">
            {t("adminDashboard.plans.description")}
          </p>
        </div>
        <Button 
        ...
        >
          {showCreateForm ? t("common.cancel") : t("adminDashboard.plans.addNewPlan")}
        </Button>
      </div>
      ...
      {showCreateForm && (
        <Card>
          <CardHeader>
            <CardTitle>{t("adminDashboard.plans.createNewPlan")}</CardTitle>
            <CardDescription>{t("adminDashboard.plans.createDescription")}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <Label>{t("adminDashboard.plans.planName")}</Label>
                <Input
                  type="text"
                  placeholder={t("adminDashboard.plans.planNamePlaceholder")}
              ...
              <div>
                <Label>{t("adminDashboard.plans.displayName")}</Label>
                <Input
                  type="text"
                  placeholder={t("adminDashboard.plans.displayNamePlaceholder")}
            ...
            <div>
              <Label>{t("adminDashboard.plans.descriptionLabel")}</Label>
              <Input
                type="text"
                placeholder={t("adminDashboard.plans.descriptionPlaceholder")}
            ...
            {paymentGateway?.yookassaEnabled && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label>Monthly Price ({yookassaCurrency} - YooKassa)</Label>
                  <Input
                    type="number"
                    step="0.01"
                    value={newPlanForm.yookassaMonthlyPrice ?? 0}
                    onChange={(e) => updateNewPlanField("yookassaMonthlyPrice", parseFloat(e.target.value))}
                    data-testid="input-new-plan-monthly-yookassa"
                  />
                </div>
                <div>
                  <Label>Yearly Price ({yookassaCurrency} - YooKassa)</Label>
                  <Input
                    type="number"
                    step="0.01"
                    value={newPlanForm.yookassaYearlyPrice ?? 0}
                    onChange={(e) => updateNewPlanField("yookassaYearlyPrice", parseFloat(e.target.value))}
                    data-testid="input-new-plan-yearly-yookassa"
                  />
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxAgents")}</Label>
              ...
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxCampaigns")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
              ...
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxContacts")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
            ...
            <div className="grid grid-cols-4 gap-4">
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxWebhooks", "Max Webhooks")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
              ...
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxKnowledgeBases", "Max KBs")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
              ...
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxFlows", "Max Flows")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
              ...
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxPhoneNumbers", "Max Phone #s")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
              ...
              <div>
                <div className="flex items-center">
                  <Label>{t("adminDashboard.plans.maxWidgets", "Max Widgets")}</Label>
                  <InfoTooltip content="Use -1 for unlimited" />
                </div>
                <Input
                  type="number"
            ...
            <div>
              <div className="flex items-center">
                <Label>{t("adminDashboard.plans.includedCredits")}</Label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label>{t("adminDashboard.plans.canChooseLlm")}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label>{t("adminDashboard.plans.canPurchaseNumbers")}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label>{t("adminDashboard.plans.useSystemPool")}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label>{t("adminDashboard.plans.activeLabel")}</Label>
                <Switch
            ...
            >
              {createPlan.isPending ? (
                <>
                  ...
                  {t("adminDashboard.plans.creating")}
                </>
              ) : (
                t("adminDashboard.plans.createPlan")
              )}
            </Button>
          </CardContent>
        </Card>
              ...
              <CardHeader>
                <div className="flex items-center justify-between gap-2 flex-wrap">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {paymentGateway?.yookassaEnabled && <YookassaSyncStatus plan={plan} yookassaCurrency={yookassaCurrency} />}
                  </div>
                </div>
                ...
                {isEditing ? (
                  <>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            type="number"
                            step="0.01"
                            value={formData.yookassaMonthlyPrice ?? 0}
                            onChange={(e) => updateField(plan.id, "yookassaMonthlyPrice", parseFloat(e.target.value))}
                            data-testid={`input-plan-monthly-yookassa-${plan.id}`}
                          />
                        </div>
                        <div>
                          <Label>Yearly Price ({yookassaCurrency} - YooKassa)</Label>
                          <Input
                            type="number"
                            step="0.01"
                            value={formData.yookassaYearlyPrice ?? 0}
                            onChange={(e) => updateField(plan.id, "yookassaYearlyPrice", parseFloat(e.target.value))}
                            data-testid={`input-plan-yearly-yookassa-${plan.id}`}
                          />
                        </div>
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <div className="flex items-center">
                          <Label>{t("adminDashboard.plans.maxContactsPerCampaign")}</Label>
                          <InfoTooltip content="Use -1 for unlimited" />
                        </div>
                        <Input
                          type="number"
                  ...
                  <>
                    <div className="space-y-2 text-sm">
                      {paymentGateway?.stripeEnabled && (
                        <div className="flex justify-between">
                          ...
                          <span>{stripeCurrencySymbol}{plan.monthlyPrice}{t("adminDashboard.plans.perMonth")} {t("adminDashboard.plans.or")} {stripeCurrencySymbol}{plan.yearlyPrice}{t("adminDashboard.plans.perYear")}</span>
                        </div>
                      )}
                      {paymentGateway?.razorpayEnabled && (
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Pricing (INR - Razorpay)</span>
                          <span>₹{plan.razorpayMonthlyPrice ?? 0}{t("adminDashboard.plans.perMonth")} {t("adminDashboard.plans.or")} ₹{plan.razorpayYearlyPrice ?? 0}{t("adminDashboard.plans.perYear")}</span>
                        </div>
                      )}
                      {paymentGateway?.paypalEnabled && (
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Pricing ({paypalCurrency} - PayPal)</span>
                          <span>{paypalCurrencySymbol}{plan.paypalMonthlyPrice ?? 0}{t("adminDashboard.plans.perMonth")} {t("adminDashboard.plans.or")} {paypalCurrencySymbol}{plan.paypalYearlyPrice ?? 0}{t("adminDashboard.plans.perYear")}</span>
                        </div>
                      )}
                      {paymentGateway?.paystackEnabled && (
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Pricing ({paystackCurrency} - Paystack)</span>
                          <span>{paystackCurrencySymbol}{plan.paystackMonthlyPrice ?? 0}{t("adminDashboard.plans.perMonth")} {t("adminDashboard.plans.or")} {paystackCurrencySymbol}{plan.paystackYearlyPrice ?? 0}{t("adminDashboard.plans.perYear")}</span>
                        </div>
                      )}
                      {paymentGateway?.mercadopagoEnabled && (
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Pricing ({mercadopagoCurrency} - MercadoPago)</span>
                          <span>{mercadopagoCurrencySymbol}{plan.mercadopagoMonthlyPrice ?? 0}{t("adminDashboard.plans.perMonth")} {t("adminDashboard.plans.or")} {mercadopagoCurrencySymbol}{plan.mercadopagoYearlyPrice ?? 0}{t("adminDashboard.plans.perYear")}</span>
                        </div>
                      )}
                      {paymentGateway?.yookassaEnabled && (
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Pricing ({yookassaCurrency} - YooKassa)</span>
                          <span>{yookassaCurrencySymbol}{plan.yookassaMonthlyPrice ?? 0}{t("adminDashboard.plans.perMonth")} {t("adminDashboard.plans.or")} {yookassaCurrencySymbol}{plan.yookassaYearlyPrice ?? 0}{t("adminDashboard.plans.perYear")}</span>
                        </div>
                      )}
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxAgents")}:</span>
                        <span>{plan.maxAgents === 999 ? t("adminDashboard.plans.unlimited") : plan.maxAgents}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxCampaigns")}:</span>
                        <span>{plan.maxCampaigns === 999 ? t("adminDashboard.plans.unlimited") : plan.maxCampaigns}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxContacts")}:</span>
                        <span>{plan.maxContactsPerCampaign === 999999 ? t("adminDashboard.plans.unlimited") : plan.maxContactsPerCampaign}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxWebhooks", "Max Webhooks")}:</span>
                        <span>{plan.maxWebhooks === 999 ? t("adminDashboard.plans.unlimited") : (plan.maxWebhooks ?? 3)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxKnowledgeBases", "Max KBs")}:</span>
                        <span>{plan.maxKnowledgeBases === 999 ? t("adminDashboard.plans.unlimited") : (plan.maxKnowledgeBases ?? 5)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxFlows", "Max Flows")}:</span>
                        <span>{plan.maxFlows === 999 ? t("adminDashboard.plans.unlimited") : (plan.maxFlows ?? 3)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxPhoneNumbers", "Max Phone #s")}:</span>
                        <span>{plan.maxPhoneNumbers === 999 ? t("adminDashboard.plans.unlimited") : (plan.maxPhoneNumbers ?? 1)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.maxWidgets", "Max Widgets")}:</span>
                        <span>{plan.maxWidgets === 999 ? t("adminDashboard.plans.unlimited") : (plan.maxWidgets ?? 1)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">{t("adminDashboard.plans.includedCredits")}:</span>
                    ...
                    <div className="flex flex-wrap gap-2 pt-2 border-t">
                      ...
                      {paymentGateway?.yookassaEnabled && (
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => syncToYookassa.mutate(plan.id)}
                          disabled={syncToYookassa.isPending || !plan.yookassaMonthlyPrice || parseFloat(plan.yookassaMonthlyPrice?.toString() || '0') === 0}
                          data-testid={`button-sync-yookassa-${plan.id}`}
                        >
                          {syncToYookassa.isPending ? (
                            <Loader2 className="h-3 w-3 mr-1 animate-spin" />
                          ) : (
                            <RefreshCw className="h-3 w-3 mr-1" />
                          )}
                    ...
                    <div className="flex gap-2">
                      <Button 
                        ...
                        className="flex-1"
                      >
                        {t("adminDashboard.plans.editPlan")}
                      </Button>
                      <Button 
      ...
      <AlertDialog open={!!deletingPlan} onOpenChange={(open) => !open && setDeletingPlan(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t("adminDashboard.plans.deletePlan")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("adminDashboard.plans.deletePlanConfirm", { name: deletingPlan?.displayName })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            >
              {deletePlan.isPending ? (
                ...
                t("adminDashboard.plans.deletePlan")
              )}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
        ...
        <AlertDialogContent className="max-w-md">
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              ...
              {t("adminDashboard.plans.migrationRequired")}
            </AlertDialogTitle>
            <AlertDialogDescription asChild>
              <div className="space-y-4">
                <p>
                  {t("adminDashboard.plans.migrationRequiredDesc", { 
                ...
                {plans && plans.filter(p => p.id !== migrationState?.plan?.id).length > 0 ? (
                  <div className="space-y-2">
                    <Label>{t("adminDashboard.plans.selectTargetPlan")}</Label>
                    <Select
                    ...
                    >
                      <SelectTrigger data-testid="select-migration-target">
                        <SelectValue placeholder={t("adminDashboard.plans.selectPlan")} />
                      </SelectTrigger>
                      <SelectContent>
                        {plans
                  ...
                  <div className="p-3 rounded-md bg-amber-500/10 border border-amber-500/20">
                    <p className="text-sm text-amber-600 dark:text-amber-400">
                      {t("adminDashboard.plans.noOtherPlansAvailable")}
                    </p>
                  </div>
                )}
              </div>
            ...
            {plans && plans.filter(p => p.id !== migrationState?.plan?.id).length > 0 && (
              ...
              >
                {migrateUsers.isPending || deletePlan.isPending ? (
                  <>
                    <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                    {t("adminDashboard.plans.migratingUsers")}
                  </>
                ) : (
                  t("adminDashboard.plans.migrateAndDelete")
                )}
              </Button>
            )}
          </AlertDialogFooter>
