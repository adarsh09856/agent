    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t("adminDashboard.plivoSettings.title")}
        </CardTitle>
        <CardDescription>
          {t("adminDashboard.plivoSettings.description")}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList>
            <TabsTrigger value="credentials" data-testid="tab-plivo-credentials">
              ...
              {t("adminDashboard.plivoSettings.tabs.credentials")}
            </TabsTrigger>
            <TabsTrigger value="pricing" data-testid="tab-phone-pricing">
              <Globe className="h-4 w-4 mr-2" />
              {t("adminDashboard.plivoSettings.tabs.pricing")}
            </TabsTrigger>
            <TabsTrigger value="phone-numbers" data-testid="tab-plivo-phone-numbers">
              <Phone className="h-4 w-4 mr-2" />
              {t("adminDashboard.plivoSettings.tabs.phoneNumbers")}
            </TabsTrigger>
          </TabsList>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold">{t("adminDashboard.plivoCredentials.title")}</h3>
          <p className="text-sm text-muted-foreground">
            {t("adminDashboard.plivoCredentials.description")}
          </p>
        </div>
        <Button
          size="sm"
        ...
        >
          ...
          {t("adminDashboard.plivoCredentials.addButton")}
        </Button>
      </div>
      ...
      <div className="border rounded-md">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>{t("adminDashboard.plivoCredentials.table.name")}</TableHead>
              <TableHead>{t("adminDashboard.plivoCredentials.table.authId")}</TableHead>
              <TableHead>{t("adminDashboard.plivoCredentials.table.primary")}</TableHead>
              <TableHead>{t("adminDashboard.plivoCredentials.table.status")}</TableHead>
              <TableHead>{t("adminDashboard.plivoCredentials.table.active")}</TableHead>
              <TableHead className="text-right">{t("adminDashboard.plivoCredentials.table.actions")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {!credentials || credentials.length === 0 ? (
              <TableRow>
                <TableCell colSpan={6} className="text-center text-muted-foreground py-8">
                  {t("adminDashboard.plivoCredentials.table.noCredentials")}
                </TableCell>
              </TableRow>
            ) : (
                  ...
                  <TableCell>
                    {cred.isPrimary && (
                      <Badge variant="secondary" className="text-blue-600 border-blue-600">
                        ...
                        {t("adminDashboard.plivoCredentials.table.primaryBadge")}
                      </Badge>
                    )}
                  </TableCell>
                  <TableCell>
                    {cred.isActive ? (
                      <Badge variant="secondary" className="text-green-600 border-green-600">
                        {t("adminDashboard.plivoCredentials.table.activeStatus")}
                      </Badge>
                    ) : (
                      <Badge variant="secondary" className="text-muted-foreground">
                        {t("adminDashboard.plivoCredentials.table.inactiveStatus")}
                      </Badge>
                    )}
                  </TableCell>
                  <TableCell>
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("adminDashboard.plivoCredentials.addDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("adminDashboard.plivoCredentials.addDialog.description")}
            </DialogDescription>
          </DialogHeader>
          <Form {...addForm}>
            <form onSubmit={addForm.handleSubmit((data) => addCredential.mutate(data))} className="space-y-4 py-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("adminDashboard.plivoCredentials.addDialog.name")}</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        placeholder={t("adminDashboard.plivoCredentials.addDialog.namePlaceholder")}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("adminDashboard.plivoCredentials.addDialog.authId")}</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        placeholder={t("adminDashboard.plivoCredentials.addDialog.authIdPlaceholder")}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("adminDashboard.plivoCredentials.addDialog.authToken")}</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        type="password"
                        placeholder={t("adminDashboard.plivoCredentials.addDialog.authTokenPlaceholder")}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                    ...
                    <FormLabel className="text-sm font-normal">
                      {t("adminDashboard.plivoCredentials.addDialog.setPrimary")}
                    </FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <DialogFooter>
                <Button type="button" variant="outline" onClick={() => setAddDialogOpen(false)}>
                  {t("adminDashboard.plivoCredentials.addDialog.cancel")}
                </Button>
                <Button
                  type="submit"
                ...
                >
                  ...
                  {t("adminDashboard.plivoCredentials.addDialog.addCredential")}
                </Button>
              </DialogFooter>
            </form>
          </Form>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("adminDashboard.plivoCredentials.editDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("adminDashboard.plivoCredentials.editDialog.description", { name: selectedCredential?.name })}
            </DialogDescription>
          </DialogHeader>
          <Form {...editForm}>
            <form onSubmit={editForm.handleSubmit((data) => {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("adminDashboard.plivoCredentials.editDialog.name")}</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
              ...
              <div className="space-y-2">
                <Label>{t("adminDashboard.plivoCredentials.editDialog.authId")}</Label>
                <Input
                ...
                />
                <p className="text-xs text-muted-foreground">{t("adminDashboard.plivoCredentials.editDialog.authIdNote")}</p>
              </div>
              <FormField
                control={editForm.control}
                name="isPrimary"
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                    ...
                    <FormLabel className="text-sm font-normal">
                      {t("adminDashboard.plivoCredentials.editDialog.setPrimary")}
                    </FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <DialogFooter>
                <Button type="button" variant="outline" onClick={() => setEditDialogOpen(false)}>
                  {t("adminDashboard.plivoCredentials.editDialog.cancel")}
                </Button>
                <Button
                  type="submit"
                ...
                >
                  ...
                  {t("adminDashboard.plivoCredentials.editDialog.update")}
                </Button>
              </DialogFooter>
            </form>
          </Form>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t("adminDashboard.plivoCredentials.deleteDialog.title")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("adminDashboard.plivoCredentials.deleteDialog.description", { name: selectedCredential?.name })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel disabled={deleteCredential.isPending}>
              {t("adminDashboard.plivoCredentials.deleteDialog.cancel")}
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={() => {
                if (selectedCredential) {
            ...
            >
              ...
              {t("adminDashboard.plivoCredentials.deleteDialog.delete")}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
...
function PhonePricingSection() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold">{t("adminDashboard.plivoPricing.title")}</h3>
          <p className="text-sm text-muted-foreground">
            {t("adminDashboard.plivoPricing.description")}
          </p>
        </div>
        <Button
          size="sm"
        ...
        >
          <Plus className="h-4 w-4 mr-2" />
          {t("adminDashboard.plivoPricing.addButton")}
        </Button>
      </div>
      ...
      <div className="border rounded-md">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>{t("adminDashboard.plivoPricing.table.countryCode")}</TableHead>
              <TableHead>{t("adminDashboard.plivoPricing.table.countryName")}</TableHead>
              <TableHead>{t("adminDashboard.plivoPricing.table.purchaseCredits")}</TableHead>
              <TableHead>{t("adminDashboard.plivoPricing.table.monthlyCredits")}</TableHead>
              <TableHead>{t("adminDashboard.plivoPricing.table.kycRequired")}</TableHead>
              <TableHead>{t("adminDashboard.plivoPricing.table.active")}</TableHead>
              <TableHead className="text-right">{t("adminDashboard.plivoPricing.table.actions")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {!pricing || pricing.length === 0 ? (
              <TableRow>
                <TableCell colSpan={7} className="text-center text-muted-foreground py-8">
                  {t("adminDashboard.plivoPricing.table.noPricing")}
                </TableCell>
              </TableRow>
            ) : (
                  ...
                  <TableCell>
                    {p.kycRequired ? (
                      <Badge variant="secondary" className="text-yellow-600 border-yellow-600">
                        {t("adminDashboard.plivoPricing.table.required")}
                      </Badge>
                    ) : (
                      <Badge variant="secondary" className="text-muted-foreground">
                        {t("adminDashboard.plivoPricing.table.no")}
                      </Badge>
                    )}
                  </TableCell>
                  <TableCell>
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("adminDashboard.plivoPricing.addDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("adminDashboard.plivoPricing.addDialog.description")}
            </DialogDescription>
          </DialogHeader>
          <Form {...addForm}>
            <form onSubmit={addForm.handleSubmit((data) => addPricing.mutate(data))} className="space-y-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("adminDashboard.plivoPricing.addDialog.countryCode")}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          placeholder={t("adminDashboard.plivoPricing.addDialog.countryCodePlaceholder")}
                          maxLength={3}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("adminDashboard.plivoPricing.addDialog.countryName")}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          placeholder={t("adminDashboard.plivoPricing.addDialog.countryNamePlaceholder")}
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("adminDashboard.plivoPricing.addDialog.purchaseCredits")}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type="number"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("adminDashboard.plivoPricing.addDialog.monthlyCredits")}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type="number"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                    ...
                    <FormLabel className="text-sm font-normal">
                      {t("adminDashboard.plivoPricing.addDialog.kycRequired")}
                    </FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <DialogFooter>
                <Button type="button" variant="outline" onClick={() => setAddDialogOpen(false)}>
                  {t("adminDashboard.plivoPricing.addDialog.cancel")}
                </Button>
                <Button
                  type="submit"
                ...
                >
                  ...
                  {t("adminDashboard.plivoPricing.addDialog.addPricing")}
                </Button>
              </DialogFooter>
            </form>
          </Form>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("adminDashboard.plivoPricing.editDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("adminDashboard.plivoPricing.editDialog.description", {
                countryName: selectedPricing?.countryName,
          ...
          <Form {...editForm}>
            <form onSubmit={editForm.handleSubmit((data) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label>{t("adminDashboard.plivoPricing.editDialog.countryCode")}</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label>{t("adminDashboard.plivoPricing.editDialog.countryName")}</Label>
                  <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("adminDashboard.plivoPricing.editDialog.purchaseCredits")}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type="number"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("adminDashboard.plivoPricing.editDialog.monthlyCredits")}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type="number"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                    ...
                    <FormLabel className="text-sm font-normal">
                      {t("adminDashboard.plivoPricing.editDialog.kycRequired")}
                    </FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-x-2 space-y-0">
                    ...
                    <FormLabel className="text-sm font-normal">
                      {t("adminDashboard.plivoPricing.editDialog.active")}
                    </FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <DialogFooter>
                <Button type="button" variant="outline" onClick={() => setEditDialogOpen(false)}>
                  {t("adminDashboard.plivoPricing.editDialog.cancel")}
                </Button>
                <Button
                  type="submit"
                ...
                >
                  ...
                  {t("adminDashboard.plivoPricing.editDialog.update")}
                </Button>
              </DialogFooter>
            </form>
          </Form>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t("adminDashboard.plivoPricing.deleteDialog.title")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("adminDashboard.plivoPricing.deleteDialog.description", { countryName: selectedPricing?.countryName })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel disabled={deletePricing.isPending}>
              {t("adminDashboard.plivoPricing.deleteDialog.cancel")}
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={() => {
                if (selectedPricing) {
            ...
            >
              ...
              {t("adminDashboard.plivoPricing.deleteDialog.delete")}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-2 flex-wrap">
        <div>
          <h3 className="text-lg font-semibold">{t("adminDashboard.plivoSetting.title")}</h3>
          <p className="text-sm text-muted-foreground">
            {t("adminDashboard.plivoSetting.description")}
          </p>
        </div>
        <Button
        ...
        >
          ...
          {t("adminDashboard.plivoSetting.syncButton")}
        </Button>
      </div>
      ...
      <Dialog open={assignDialogOpen} onOpenChange={(open) => {
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("adminDashboard.plivoSetting.assignDialog.title")}</DialogTitle>
            <DialogDescription>
              {t("adminDashboard.plivoSetting.assignDialog.description", { phoneNumber: selectedPhone?.phoneNumber })}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label>{t("adminDashboard.plivoSetting.assignDialog.assignTo")}</Label>
              <Popover open={userSearchOpen} onOpenChange={setUserSearchOpen}>
                ...
                <PopoverContent className="w-[400px] p-0" align="start">
                  <Command shouldFilter={false}>
                    <CommandInput
                      placeholder={t("adminDashboard.plivoSetting.assignDialog.searchPlaceholder")}
                      value={userSearchQuery}
                      onValueChange={setUserSearchQuery}
                      data-testid="input-plivo-user-search"
                    />
                    <CommandList>
                      {!isSearchingUsers && <CommandEmpty>{t("adminDashboard.plivoSetting.assignDialog.noUsersFound")}</CommandEmpty>}
                      <CommandGroup>
                        <CommandItem
                          value="system_pool"
                          onSelect={() => {
                        ...
                        >
                          ...
                          {t("adminDashboard.plivoSetting.assignDialog.systemPool")}
                        </CommandItem>
                        {isSearchingUsers && (
                          <div className="flex items-center justify-center py-4">
                            <Loader2 className="h-4 w-4 animate-spin mr-2" />
                            <span className="text-sm text-muted-foreground">{t("plivoSetting.assignDialog.searching")}</span>
                          </div>
                        )}
                        ...
                        {!isSearchingUsers && userSearchResponse?.hasMore && (
                          <div className="px-2 py-2 text-xs text-muted-foreground text-center border-t">
                            {t("adminDashboard.plivoSetting.assignDialog.searchMore", { total: userSearchResponse.total })}
                          </div>
                        )}
                      </CommandGroup>
                    </CommandList>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setAssignDialogOpen(false)} data-testid="button-plivo-cancel-assign">
              {t("adminDashboard.plivoSetting.assignDialog.cancel")}
            </Button>
            <Button onClick={handleAssign} disabled={assignNumber.isPending} data-testid="button-plivo-confirm-assign">
              ...
              {t("adminDashboard.plivoSetting.assignDialog.assign")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <div className="border rounded-md">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>{t("adminDashboard.plivoSetting.table.phoneNumber")}</TableHead>
              <TableHead>{t("adminDashboard.plivoSetting.table.country")}</TableHead>
              <TableHead>{t("adminDashboard.plivoSetting.table.type")}</TableHead>
              <TableHead>{t("adminDashboard.plivoSetting.table.status")}</TableHead>
              <TableHead>{t("adminDashboard.plivoSetting.table.assignment")}</TableHead>
              <TableHead>{t("adminDashboard.plivoSetting.table.actions")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {!phoneNumbers || phoneNumbers.length === 0 ? (
              <TableRow>
                <TableCell colSpan={6} className="text-center text-muted-foreground py-8">
                  {t("adminDashboard.plivoSetting.table.noNumbers")}
                </TableCell>
              </TableRow>
            ) : (
                  ...
                  <TableCell>
                    {num.isSystemPool ? (
                      <Badge variant="outline">
                        ...
                        {t("adminDashboard.plivoSetting.table.systemPool")}
                      </Badge>
                    ) : num.userId ? (
                      <Badge variant="secondary">{num.userEmail || t("adminDashboard.plivoSetting.table.assigned")}</Badge>
                    ) : (
                      <Badge variant="outline">{t("adminDashboard.plivoSetting.table.unassigned")}</Badge>
                    )}
                  </TableCell>
                  <TableCell>
                    <Button
                    ...
                    >
                      ...
                      {num.userId || num.isSystemPool ? t("adminDashboard.plivoSetting.table.reassign") : t("adminDashboard.plivoSetting.table.assign")}
                    </Button>
                  </TableCell>
                </TableRow>
              ))
