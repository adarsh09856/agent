        ...
        <div className="w-full max-w-md px-8 py-12">
          ...
          {userName && (
            ...
            >
              <h2 className="text-xl font-semibold text-foreground">
                {t('adminDashboard.loadingAnimation.welcome', { name: userName })}
              </h2>
            </motion.div>
          )}
          ...
          >
            <h3 className="text-lg font-medium text-foreground mb-1">
              {t(`adminDashboard.loadingAnimation.${loadingSteps[currentStep]?.id}Label`)}
            </h3>
            <p className="text-sm text-muted-foreground">
              {t(`adminDashboard.loadingAnimation.${loadingSteps[currentStep]?.id}Sublabel`)}
            </p>
          </motion.div>
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-between mt-2 text-xs text-muted-foreground">
              <span>{t('adminDashboard.loadingAnimation.settingUp')}</span>
