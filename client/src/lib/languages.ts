...
export const SUPPORTED_LANGUAGES: LanguageOption[] = [
  ...
  { value: "bn", label: "Bengali", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  ...
  { value: "en", label: "English", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  ...
  { value: "gu", label: "Gujarati", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  { value: "ha", label: "Hausa", providers: ["elevenlabs"] },
  { value: "he", label: "Hebrew", providers: ["elevenlabs","openai","deepgram"] },
  { value: "hi", label: "Hindi", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  ...
  { value: "kn", label: "Kannada", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  ...
  { value: "ml", label: "Malayalam", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  { value: "mr", label: "Marathi", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  { value: "ne", label: "Nepali", providers: ["elevenlabs","deepgram"] },
  { value: "no", label: "Norwegian", providers: ["elevenlabs","openai","deepgram"] },
  { value: "or", label: "Odia", providers: ["elevenlabs","sarvam"] },
  ...
  { value: "pa", label: "Punjabi", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  ...
  { value: "ta", label: "Tamil", providers: ["elevenlabs","openai","deepgram","sarvam"] },
  { value: "te", label: "Telugu", providers: ["elevenlabs","openai","deepgram","sarvam"] },
