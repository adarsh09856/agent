  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        {batchJobData?.stats && (() => {
          const prog = batchJobData.stats.progress ?? (
              ...
              <Card className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="p-4 rounded-lg bg-muted/50">
                    ...
                    <p className="text-2xl font-semibold">{batchJobData.stats.pending ?? 0}</p>
                  </div>
                  <div className="p-4 rounded-lg bg-blue-500/10">
                    <p className="text-sm text-muted-foreground">In Progress</p>
                    <p className="text-2xl font-semibold text-blue-500">{batchJobData.stats.in_progress ?? 0}</p>
                  </div>
                  <div className="p-4 rounded-lg bg-green-500/10">
                    <p className="text-sm text-muted-foreground">Completed</p>
                    <p className="text-2xl font-semibold text-green-500">{batchJobData.stats.completed ?? 0}</p>
                  </div>
                  <div className="p-4 rounded-lg bg-red-500/10">
                    <p className="text-sm text-muted-foreground">Failed</p>
                    <p className="text-2xl font-semibold text-red-500">{batchJobData.stats.failed ?? 0}</p>
                  </div>
                </div>
                <div className="mt-4">
