...
export default function AppointmentsPage() {
  ...
  const getTabAppointments = (tab: string) => {
    switch (tab) {
      ...
      case "upcoming":
        return allAppointments.filter((a) => isAfter(new Date(a.scheduledFor), now));
      case "past":
  ...
  const tabCounts = {
    ...
    upcoming: allAppointments.filter((a) => isAfter(new Date(a.scheduledFor), now)).length,
