...
export type PaymentGateway = 'stripe' | 'razorpay' | 'paypal' | 'paystack' | 'mercadopago' | 'yookassa';
...
export const GLOBAL_SETTINGS_KEYS = {
  ...
  YOOKASSA_CURRENCY: 'yookassa_currency',
  YOOKASSA_LAST_WEBHOOK_AT: 'yookassa_last_webhook_at',
