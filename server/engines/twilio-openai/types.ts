...
export const MODEL_TIER_CONFIG: Record<ModelTier, { models: OpenAIRealtimeModel[]; safeFallback: OpenAIRealtimeModel; description: string }> = {
  free: {
    models: ['gpt-realtime-mini', 'gpt-4o-mini-realtime-preview'],
    safeFallback: 'gpt-realtime-mini',
