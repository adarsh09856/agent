...
import { PLIVO_PRICING_SEED_DATA, seedPlivoPhonePricing } from "./seed-plivo-pricing";
...
export async function runAllSeedsForInstaller(): Promise<{
  ...
  try {
    ...
    await seedPlivoPhonePricing();
    summary.plivoPhonePricing = PLIVO_PRICING_SEED_DATA.length;
...
export async function runAllSeeds() {
  ...
  try {
    ...
    console.log(`   - Plivo Phone Pricing: ${PLIVO_PRICING_SEED_DATA.length} countries seeded`);
