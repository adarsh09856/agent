...
export interface CallInsights {
  ...
  classification: 'hot' | 'warm' | 'neutral' | 'cold' | 'lost';
  keyPoints?: string[];
  nextActions?: string[];
}
...
- "neutral": Caller was polite but showed no clear interest or disinterest
...
export class CallInsightsService {
  ...
  private static validateInsights(insights: any): insights is CallInsights {
    ...
    const validClassifications = ['hot', 'warm', 'neutral', 'cold', 'lost'];
