...
const CONTACT_INSERT_RETAIN_RESULTS_THRESHOLD = 1500;
...
async function batchInsertContacts(contactInserts, logPrefix = "[Batch Insert]", options = {}) {
...
export {
  CONTACT_INSERT_RETAIN_RESULTS_THRESHOLD,
  batchInsertCalls,
  batchInsertContacts,
