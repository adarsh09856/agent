...
const flowTestQueue = pgTable("flow_test_queue", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull(),
...
const insertFlowTestQueueSchema = createInsertSchema(flowTestQueue).omit({
  id: true,
  createdAt: true
});
...
const googleCalendarCredentials = pgTable("google_calendar_credentials", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique(),
...
const insertGoogleCalendarCredentialSchema = createInsertSchema(googleCalendarCredentials).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
const googleSheetsCredentials = pgTable("google_sheets_credentials", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  userId: varchar("user_id").notNull().unique(),
  accessToken: text("access_token").notNull(),
  refreshToken: text("refresh_token").notNull(),
...
const insertGoogleSheetsCredentialSchema = createInsertSchema(googleSheetsCredentials).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
const phoneReleaseRetryQueue = pgTable("phone_release_retry_queue", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
const insertPhoneReleaseRetryQueueSchema = createInsertSchema(phoneReleaseRetryQueue).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
const veAgentInstantFaqs = pgTable("ve_agent_instant_faqs", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  agentId: varchar("agent_id").notNull(),
  userId: varchar("user_id").notNull(),
...
const insertVeAgentInstantFaqSchema = createInsertSchema(veAgentInstantFaqs).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
const veMasterAiGlobalSettings = pgTable("ve_master_ai_global_settings", {
  id: serial("id").primaryKey(),
...
const insertVeMasterAiGlobalSettingsSchema = createInsertSchema(veMasterAiGlobalSettings).omit({
  id: true,
  updatedAt: true
});
export {
  ...
  insertFlowSchema,
  insertFlowTestQueueSchema,
  insertFormFieldSchema,
  insertFormSchema,
  insertFormSubmissionSchema,
  insertGlobalSettingsSchema,
  insertGoogleCalendarCredentialSchema,
  insertGoogleSheetsCredentialSchema,
